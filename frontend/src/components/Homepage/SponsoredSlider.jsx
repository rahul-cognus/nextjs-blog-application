...
const cardData = [
  ...
  {
    imageSrc: "/images/blog/4by3/09.jpg",
    category: "Marketing",
  ...
  {
    imageSrc: "/images/blog/4by3/10.jpg",
    category: "Photography",
    categoryStyle: "bg-blue-500 text-white [&>span]:bg-white",
    isSponsored: false,
  ...
  {
    imageSrc: "/images/blog/4by3/11.jpg",
    category: "Technology",
...
const SponsoredSlider = ({ posts }) => {
  const [isActive, setIsActive] = useState(false);
  return (
    <div className="container">
      <Heading icon={<BsMegaphone />} heading="Sponsored news" />
      <div
